...
namespace ServerCodeMtk_P2_073
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri address = new Uri("http://localhost:2003/Matematika");
            ...
            try
            {
                ...
                smb.HttpGetEnabled = true; //untuk mengaktifkan  (dibuka saat development, tidak untuk dibuka)
